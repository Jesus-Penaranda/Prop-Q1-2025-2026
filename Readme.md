...
> [!CAUTION]
> La normalización de distancias es **crítica** para evitar que atributos con rangos mayores dominen el análisis. Sin normalización, una pregunta numérica con rango 0-100 influiría más que respuestas categóricas con 3-5 opciones.
...
> [!NOTE]
> El proyecto usa Gradle Wrapper (`gradlew`), por lo que no necesitas tener Gradle instalado globalmente. El wrapper se descargará automáticamente en la primera ejecución.
...
La aplicación implementa una interfaz gráfica profesional construida con **Java Swing** con un diseño limpio e intuitivo basado en tarjetas y navegación fluida mediante `CardLayout`.

### Login y Panel Principal

Pantalla de autenticación con soporte multi-usuario y listado de encuestas activas:

| Login | Gestión de Encuestas |
|:---:|:---:|
| ![Login de la aplicación](DOCS/img/interfaz-000.png) | ![Listado principal de encuestas](DOCS/img/interfaz-002.png) |

### Creación y Edición de Encuestas

Editor visual completo con soporte para múltiples tipos de preguntas y configuración dinámica:

| Formulario Vacío | Con Preguntas Cargadas |
|:---:|:---:|
| ![Vista de creación de encuesta](DOCS/img/interfaz-004.png) | ![Creación de encuesta con preguntas](DOCS/img/interfaz-006.png) |

### Respuesta y Edición

Interfaces específicas para responder encuestas y modificar preguntas existentes:

| Responder Encuesta | Editar Preguntas |
|:---:|:---:|
| ![Vista para responder encuestas](DOCS/img/interfaz-008.png) | ![Vista de edición de encuesta](DOCS/img/interfaz-010.png) |

### Clustering: Configuración y Análisis

Paneles de control para configurar algoritmos, calcular $k$ óptimo y visualizar curvas de calidad:

| Configuración | K Óptimo Encontrado |
|:---:|:---:|
| ![Configuración de clustering](DOCS/img/interfaz-012.png) | ![K óptimo y curva de calidad](DOCS/img/interfaz-014.png) |

### Análisis Extendido y Visualización 2D

Vistas detalladas de clusters y proyección en dos dimensiones utilizando PCA:

| Análisis de Clusters | Gráfica 2D Interactiva |
|:---:|:---:|
| ![Vista de análisis de clusters](DOCS/img/interfaz-016.png) | ![Gráfica 2D simulada de clustering](DOCS/img/interfaz-018.png) |
